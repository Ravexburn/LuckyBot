...
:white_check_mark: This server is on the whitelist.`);
					...
					guild.owner.send("Your server is not currently whitelisted. Please join here to have Lucky Bot be whitelisted and added to your server. **If Lucky Bot is on your server, you may ignore this message as it is already whitelisted!** https://discord.gg/z4thPtW");
					guild.leave();
